...
const { readAllPortfolios } = require("../common/portfolioHelper");
...
class KeyFleet {
   ...
   */
  getAllAddresses2(portfolioName = "default") {
    const addresses = this.getAllAddresses(portfolioName);
    const data = {
      holderAddresses: addresses,
    };
    return data;
